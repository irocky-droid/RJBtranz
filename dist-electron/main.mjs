...
const { app, BrowserWindow, Menu, shell, dialog, ipcMain, systemPreferences } = electron;
...
function createWindow() {
    console.log('main.mjs: Creating main window...');
    ...
    console.log('main.mjs: Loading URL:', startUrl);
