...
*Note: `users` and `countries` tables are illustrative and managed by Supabase Auth and application logic respectively.*
...
1. Open your Supabase dashboard: https://dpynwadvbbauevdvxjin.supabase.co
2. Go to SQL Editor
