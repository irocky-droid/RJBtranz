...
class _FallbackExchangeRateAPI {
  private static baseRates: ExchangeRate[] = [
    // Africa
    { pair: "USD/GHS", rate: 12.45, change: 0, changePercent: 0, lastUpdated: new Date().toISOString(), region: 'africa' },
    { pair: "USD/NGN", rate: 795.50, change: 0, changePercent: 0, lastUpdated: new Date().toISOString(), region: 'africa' },
    { pair: "USD/KES", rate: 129.75, change: 0, changePercent: 0, lastUpdated: new Date().toISOString(), region: 'africa' },
    ...
    // Europe
    { pair: "USD/EUR", rate: 0.9174, change: 0, changePercent: 0, lastUpdated: new Date().toISOString(), region: 'europe' },
    { pair: "USD/GBP", rate: 0.7874, change: 0, changePercent: 0, lastUpdated: new Date().toISOString(), region: 'europe' },
    { pair: "USD/CHF", rate: 0.88, change: 0.002, changePercent: 0.23, lastUpdated: new Date().toISOString(), region: 'europe' },

    // Americas
    { pair: "USD/CAD", rate: 1.3514, change: 0, changePercent: 0, lastUpdated: new Date().toISOString(), region: 'north-america' },
    ...
    // Oceania
    { pair: "USD/AUD", rate: 1.4925, change: 0, changePercent: 0, lastUpdated: new Date().toISOString(), region: 'oceania' },
...
const ExchangeRateService: React.FC<ExchangeRateServiceProps> = ({
  ...
  useEffect(() => {
    ...
    // Set up interval - no initial fetch on mount
    const interval = setInterval(refreshRates, refreshInterval);

    return () => clearInterval(interval);
  }, [isAutoRefresh, refreshInterval, refreshRates]);
